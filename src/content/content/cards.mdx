...
Four components for navigational content: `Card` (a standalone link card),
...
your cards have arbitrary hrefs not tied to the content collection. A curated
list of links on a landing page is the typical use case.
...
<CardGrid>
  <Card href="/" title="Getting Started" description="Install your first astro-better-* package." />
  <Card href="/" title="Components" description="Browse the full component library." />
</CardGrid>
