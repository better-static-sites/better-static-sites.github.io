...
<p class="pkg-meta">Current version: <strong>0.4.1</strong> &mdash; <a href="https://www.npmjs.com/package/astro-better-declarative-screenshots" target="_blank" rel="noopener">npm</a></p>
