...
<p class="pkg-meta">Current version: <strong>0.1.0</strong> &mdash; <a href="https://www.npmjs.com/package/astro-mermaid-renderer-cli-smol" target="_blank" rel="noopener">npm</a></p>
