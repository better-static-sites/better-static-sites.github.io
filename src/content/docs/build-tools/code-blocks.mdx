...
<p class="pkg-meta">Current version: <strong>0.1.4</strong> &mdash; <a href="https://www.npmjs.com/package/astro-better-code-blocks" target="_blank" rel="noopener">npm</a></p>
